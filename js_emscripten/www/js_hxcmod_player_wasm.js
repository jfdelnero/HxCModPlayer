...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'js_hxcmod_player_wasm.wast';
  var wasmBinaryFile = 'js_hxcmod_player_wasm.wasm';
  var asmjsCodeFile = 'js_hxcmod_player_wasm.temp.asm.js';
...
var _getNextSoundData = Module["_getNextSoundData"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_getNextSoundData"].apply(null, arguments) };
var _loadMod = Module["_loadMod"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_loadMod"].apply(null, arguments) };
...
var _unloadMod = Module["_unloadMod"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_unloadMod"].apply(null, arguments) };
